...
import com.luis.dev.meliapp.features.results.presentation.components.ResultsList
 ...
 *
 * @param resultsState El estado actual de la búsqueda, que contiene información como resultados, errores y estado de carga.
 */
@Composable
fun ResultsScreen(
...
fun ResultScreenErrorPreview() {
    val dummyState = ResultsState(error = "Something went wrong")
    MeliAppTheme {
        ResultsScreen(
            resultsState = dummyState,
            navToDetailScreen = {},
...
fun ResultScreenNoResultsPreview() {
    val dummyState = ResultsState(results = emptyList())
    MeliAppTheme {
        ResultsScreen(
            resultsState = dummyState,
            navToDetailScreen = {},
